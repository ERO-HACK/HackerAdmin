...
echo -e "\t${colors[rand1]} __   __  _______  _______  ___   _   _______  ______   __   __  ___  __    _ "
echo -e "\t${colors[rand1]}|  | |  ||   _   ||       ||   | | | |   _   ||      | |  |_|  ||   ||  |  | |"
echo -e "\t${colors[rand1]}|  |_|  ||  |_|  ||       ||   |_| | |  |_|  ||  _    ||       ||   ||   |_| |"
echo -e "\t${colors[rand1]}|       ||       ||      _|          |       || | |   ||       ||   ||       |"
echo -e "\t${colors[rand1]}|       ||       ||      _||     |_  |       || |_|   ||       ||   ||  _    |"
echo -e "\t${colors[rand1]}|   _   ||   _   ||     |_ |    _  | |   _   ||       || ||_|| ||   || | |   |"
echo -e "\t${colors[rand1]}|__| |__||__| |__||_______||___| |_| |__| |__||______| |_|   |_||___||_|  |__|"
        echo -e "                 \t${bd}${g}╭${w} Author  ${b}:${c} ${ul}ERO-HACK${n}          ${g}${n}"
        echo -e "                 \t${bd}${g}│${w} Version ${b}:${w} 2.0.0                          ${g}${n}"
        echo -e "                 \t${bd}${g}│${w} Code    ${b}:${w} Bash, python                   ${g}${n}"
        echo -e "     \t${bd}${g} ╭──────────────┴${w} Date    ${b}:${w} 11 15 2023                 ${g}${n}"
}
